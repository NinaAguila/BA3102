...
<body>
    ...
    <nav>
        ...
        <li style="text-align: center; color: white; font-family: 'Aclonica'; font-size: 30px;">UniHire Job Portal</li>
            <li><a class="nav-item" href="job_board.php">Jobs</a></li>
        </ul>
    </nav>

    <h4>
    <a href="https://batstate-u.edu.ph/campuses/lipa/" target="_blank">
    <img id="logo" src="https://batstate-u.edu.ph/wp-content/uploads/2022/05/BatStateU-NEU-Logo.png" alt="University Logo">
    </a>
    </h4>
    ...
    <main>
    <h2 style="color: #000000; font-family: 'Aclonica', sans-serif; font-size: 20px;">HR LOGIN</h2>
    

    
    <p style="text-align: center;">Please input <strong>Username</strong> and <strong>Password</strong> to Login to your account.</p>
    ...
    <div class="textbox-container">
        <input type="text" class="textbox" name="username" placeholder="Email Address" required>
